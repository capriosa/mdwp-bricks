...
import { LayoutProp } from '../../utils/LayoutSideProps'
...
const MdwpTextImage: types.Brick<TextImageProps> = ({
  ...
  return (
    <Section borderTop={borderTop} borderBottom={borderBottom}>
      <Container
        size={width}
...
MdwpTextImage.schema = {
  name: blockNames.TextImage,
  label: 'mdwp Text Image',
  ...
  repeaterItems: [
    {
      name: 'badge',
      itemType: blockNames.NewsletterSubscribe,
      itemLabel: 'Badge',
      min: 0,
      max: 10,
    },
