  ...
  return (
    <div className="tab text-red-500 w-min mr-6 float-left" {...rest}>
      ...
      <label className="p-18 cursor-pointer" htmlFor={horicontaltab}>{horicontaltab}</label>
          ...
          <Fade right><div className='flex justify-between'>
          <div className='bg-red-500 mt-32 pt-24 pb-44 w-3/5 pr-28 px-8'>
          <Text
            propName="headline"
          ...
          <RichText
            propName="text"
            placeholder="Type a text..."
            renderBlock={({ children }) => (<p className='text-white border-b-2 pb-5 border-white font-semibold text-4xl leading-normal'>{children}</p>)}
          ...
          <Image
            ...
            maxWidth={200}
            aspectRatio={1}
            imageClassName="shadow-2xl shadow-red-500-50 absolute left-1/2 w-3/5"
          />
          </div>
          </Fade>
      </div>
